const styles = {
  ...
  background: "linear-gradient(45deg, #FFC947, #FFE4B5)", // Example background gradient

  heroHeadText: "font-black text-white lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2",
  heroSubText: "text-[#dfd9ff] font-medium lg:text-[25px] sm:text-[20px] xs:text-[18px] text-[16px] lg:leading-[40px]",
